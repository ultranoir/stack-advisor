  ...
  <div class="min-h-screen bg-slate-900 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-white">{{ $t('auth.loginTitle') }}</h1>
        <p class="text-slate-400 mt-2">{{ $t('auth.loginSubtitle') }}</p>
      </div>

      <!-- Login card -->
      <div class="bg-white rounded-2xl shadow-xl p-8">
        <h2 class="text-xl font-semibold text-slate-800 mb-2">{{ $t('auth.login') }}</h2>
        <p class="text-slate-500 mb-6">{{ $t('auth.loginDescription') }}</p>
